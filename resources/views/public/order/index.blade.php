                    ...
                    <form action="{{url('/order/save')}}" method="POST" class="form-horizontal">
                        ...
                        <div class="form-group">
                           ...
                           <input type="radio" class="class_payment" name="payment_type" value="cash_on_delivery" checked=""> Cash on Delivery
                            ...
                            <br>
                            <div class="form-control">
                                <input type="radio" class="class_payment" name="payment_type" value="rocket"> Rocket
                            </div>
                        </div>
                        <div class="bkash-val" style="display: none;">
                            ...
                            <div class="form-group">
                             <label class="">Txn id</label>
                             <input type="text" class="form-control" name="txn_id" value="">
                            </div> 
                            <div class="form-group">
                             <label class="">GoFlix Bkash Number</label>
                             <input type="text" class="form-control" value="01788225110" disabled="">
                            </div> 
                        </div>

                        <div class="rocket-val" style="display: none;">
                            <div class="form-group">
                             <label class="">User Mobile Number</label>
                             <input type="text" class="form-control" name="rocket_no" value="">
                            </div> 
                            <div class="form-group">
                             <label class="">Txn id</label>
                             <input type="text" class="form-control" name="rocket_txn_id" value="">
                            </div> 
                            <div class="form-group">
                             <label class="">GoFlix Rocket Number</label>
                             <input type="text" class="form-control" value="01788225110" disabled="">
                            </div> 
                        </div>
